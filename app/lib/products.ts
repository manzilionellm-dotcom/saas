...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Montrez un produit ou collez un lien : SilkRoute cherche le meilleur prix sur les grands sites chinois (Taobao, 1688, Pinduoduo, AliExpress, Alibaba, DHgate, Temu, Banggood…), compare la qualité (notes & vendeurs vérifiés), puis passe par un agent d'achat (Superbuy, CSSBuy) pour consolider, expédier et dédouaner jusqu'en Suède. Objectif : le moins cher possible, en haute qualité, en toute confiance.",
    category: "E-commerce",
    icon: "🐉",
    monthlyPrice: 49,
    features: [
